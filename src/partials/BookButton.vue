<template>
  <button
    class="btn-sm text-white bg-yellow-500 hover:bg-yellow-400 hover:scale-105 transition-all w-full shadow-sm max-w-xs"
    @click="onBook"
  >
    <svg
      width="20px"
...
export default {
  setup() {
    function onBook() {
      window.open(
        "https://hotels.cloudbeds.com/en/reservation/5pHctM?ga_sess_id=1850527884.1706332862",
        "_blank"
      );
    }
