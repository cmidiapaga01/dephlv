  ...
  <section class="relative">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        <!-- Hero content -->
        <div
          class="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row"
        >
          <!-- Content -->
          <div class="md:w-[640px]">
            ...
            >
              Welcome to the
              <span class="relative inline-flex text-yellow-400">
                <svg
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Hostel Hasta la Vista is concepted as a home away from home for
              students, youngsters and explorers. Our aim is to creat a warm
              environment with convenient prices.
            </p>
            <!-- Buttons -->
            <div
            ...
            >
              <div
                class="visible sm:visible md:visible lg:invisible xl:invisible"
              >
                <BookButton />
              </div>
              <div
          ...
          >
            <img
              src="../images/hero_home-mobile.png"
              class="md:max-w-none main_image"
              width="584"
              height="659"
...
import InstaButton from "./InstaButton.vue";

export default {
  name: "Hero",
  components: { BookButton, InstaButton },
};
</script>
