      ...
      <div class="py-4">
        ...
        <div class="md:pb-14">
          <div class="relative text-center md:text-left">
            <svg
              class="fill-yellow-300 hidden md:block absolute -ml-7 -mt-8"
              width="22"
              height="30"
            ...
            <h2 class="h2 font-cabinet-grotesk">Keep up with Sarandë</h2>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <!-- Images grid -->
            <div
              class="max-w-sm mx-auto sm:max-w-none grid gap-6 sm:grid-cols-2 md:grid-cols-3 items-start"
              data-aos-id-inpspiration
            >
              <!-- 1st Gallery Image -->
              <a
                class="relative group hover:shadow-xl transition duration-150 ease-in-out"
                href="#0"
                v-show="['0', '1', '3'].includes(category)"
                data-aos="fade-down"
              ...
              >
                ...
                >
                  <!-- Backdrop -->
                  <div
                    class="absolute inset-0 -mt-4 bg-gradient-to-t from-gray-800 to-transparent opacity-80 pointer-events-none"
                    aria-hidden="true"
                  ></div>
                  <!-- Content -->
                  <div class="relative flex justify-between">
                    ...
                    <div class="flex items-center">
                      <img
                        class="shrink-0 w-9 h-9 rounded-full mr-4"
                      ...
                      <div class="truncate">
                        ...
                        <div class="text-xs text-white opacity-60 truncate">
                          @ada-designer-ok
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="flex flex-nowrap items-center ml-2">
                      ...
                      <div
                        class="whitespace-nowrap text-sm text-white opacity-90 ml-2"
                      >
                        4K
                      </div>
                    </div>
              ...
              <a
                class="relative group hover:shadow-xl transition duration-150 ease-in-out"
                href="#0"
                v-show="['0', '2', '3'].includes(category)"
                data-aos="fade-down"
                data-aos-anchor="[data-aos-id-inpspiration]"
                data-aos-delay="100"
              >
                ...
                >
                  ...
                  <div class="relative flex justify-between">
                    ...
                    <div class="flex items-center">
                      <img
                        class="shrink-0 w-10 h-10 rounded-full mr-4"
                        src="../images/author-01.jpg"
                        width="40"
                        height="40"
                        alt="Author 01"
              ...
              <a
                class="relative group hover:shadow-xl transition duration-150 ease-in-out"
                href="#0"
                v-show="['0', '1', '3', '4'].includes(category)"
                data-aos="fade-down"
                data-aos-anchor="[data-aos-id-inpspiration]"
                data-aos-delay="200"
              >
            ...
            <!-- CTA -->
            <!-- <div
              class="absolute bottom-0 left-0 right-0 h-[352px] bg-gradient-to-t from-white to-transparent"
            >
              <div class="flex h-full items-end justify-center">
                <router-link
                  class="btn text-white bg-blue-500 hover:bg-blue-600 shadow-sm mb-6"
                  to="/signup"
